...
function anss = ObjFun(ttt, id)
    ...
    for zzz = 1:2
        ...
        for i = 1:3
            H(1) = min(n(i) * ma1(i, 1) * (1 - ttt(i)) + n(i) * (1 - ma1(i, 1)), H(1));
        end
        for i = 1:3
            H(2) = min(n(i + 3) * ma1(i + 3, 1) * (1 - ttt(i)) + n(i + 3) * (1 - ma1(i + 3, 1)), H(2));
        end
        for i = 1:2
            H(3) = min(n(i + 6) * ma1(i + 6, 1) * (1 - ttt(i)) + n(i + 6) * (1 - ma1(i + 6, 1)), H(3));
        end
        for i = 1:3
